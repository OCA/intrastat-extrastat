...
This module is an alternative to the basic invoice view of the intrastat module, remplacing the hs_code table at the end of the invoice  by directly showing hs_code on invoivce's lines.
