...
from .common_purchase import IntrastatPurchaseLotCommon


class TestIntrastatProductPurchaseLot(IntrastatPurchaseLotCommon):
    ...
    def test_purchase_to_invoice_default(self):
        ...
        for line in self.purchase.picking_ids.move_line_ids:
            ...
            line.lot_id = self.product_lot.id
...
class TestIntrastatProductPurchaseLotCase(
    TestIntrastatProductPurchaseLot, SavepointCase
):
